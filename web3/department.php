      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        ...
        <div class="col-lg-4">
          <div class="text-center">
            ...
            ?>
            <img src="<?php echo $imgUrl.$profile->avatarImage;?>" class="bd-placeholder-img" width="130" height="180">
            <?php
            }else{
            ?>
            <img src="img/no-user-image.gif" class="bd-placeholder-img" width="130" height="180">
            <?php
            }
            ?>
